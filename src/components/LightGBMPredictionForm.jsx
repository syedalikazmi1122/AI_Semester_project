...
const LightGBMPredictionForm = ({ onSubmit, isLoading }) => {
  ...
  return (
    <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">LightGBM Model</h2>
        <p className="text-gray-400">Gradient boosting framework with tree-based learning algorithms</p>
      </div>
...
export default LightGBMPredictionForm;